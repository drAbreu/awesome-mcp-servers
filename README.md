...
- [drAbreu/alex-mcp]([https://github.com/longevity-genie/biothings-mcp](https://github.com/drAbreu/alex-mcp)) 🐍 ☁️ - MCP server to interact with BioThings API, including genes, genetic variants, drugs, and taxonomic information 

### 🧬 <a name="science"></a>Scientific Literature
- [longevity-genie/biothings-mcp](https://github.com/longevity-genie/biothings-mcp) 🧬 - Professional MCP server providing ML-powered author disambiguation and comprehensive researcher profiles using the OpenAlex database.
